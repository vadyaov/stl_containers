...
TEST_F(TestMap, cpy_ctor) {
  std::map<int, int> mstd {ii_pair(1, 121), ii_pair(2, 122), ii_pair(3, 123), ii_pair(4, 124)};
  s21::map<int, int> ms21 {ii_pair(1, 121), ii_pair(2, 122), ii_pair(3, 123), ii_pair(4, 124)};
...
TEST_F(TestMap, cpy_assignment) {
  const std::map<int, int> mstd {ii_pair(1, 121), ii_pair(2, 122), ii_pair(3, 123), ii_pair(4, 124)};
  const s21::map<int, int> ms21 {ii_pair(1, 121), ii_pair(2, 122), ii_pair(3, 123), ii_pair(4, 124)};
  ASSERT_EQ(ms21.size(), mstd.size());
...
TEST_F(TestMap, at) {
  s21::map<int, int> A ({ii_pair(1, 123), ii_pair(2, 345), ii_pair(2, 456), ii_pair(3, 567)});
  std::map<int, int> B({ii_pair(1, 123), ii_pair(2, 345), ii_pair(2, 456), ii_pair(3, 567)});
...
TEST_F(TestMap, insert1) {
  s21::map<double, char> A ({std::pair<double, char>(0.234567, 'a'), std::pair<double, char>(9.5678, 'b'), std::pair<double, char>(9.5678, 'c'), std::pair<double, char>(3.45678, 'd')});
  std::map<double, char> B({std::pair<double, char>(0.234567, 'a'), std::pair<double, char>(9.5678, 'b'), std::pair<double, char>(9.5678, 'c'), std::pair<double, char>(3.45678, 'd')});
...
TEST_F(TestMap, emplace) {
  s21::map<char, char> A({std::pair<char, char>('a', '1'), std::pair<char, char>('b', '2'), std::pair<char, char>('b', '3'), std::pair<char, char>('c', '4'), std::pair<char, char>('d', '5')});
  std::map<int, int> B(
          {std::pair<char, char>('a', '1'), std::pair<char, char>('b', '2'), std::pair<char, char>('b', '3'), std::pair<char, char>('c', '4'), std::pair<char, char>('d', '5')});
