...
TEST(method, equal_range) {
    s21::multiset<int> a{1, 1, 1, 2, 2, 2, 3, 3, 3, 4, 4, 5};
    std::multiset<int> c{1, 1, 1, 2, 2, 2, 3, 3, 3, 4, 4, 5};
    std::pair<s21::multiset<int>::iterator, s21::multiset<int>::iterator> b0 = a.equal_range(2);
    std::pair<std::multiset<int>::iterator, std::multiset<int>::iterator> d0 = c.equal_range(2);
    ...
    std::pair<s21::multiset<int>::iterator, s21::multiset<int>::iterator> b1 = a.equal_range(4);
    std::pair<std::multiset<int>::iterator, std::multiset<int>::iterator> d1 = c.equal_range(4);
